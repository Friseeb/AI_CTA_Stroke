#!/usr/bin/env python
"""
plot_06_laa_la_ratio.py — LAA/LA median HU ratio (LAA-valid rows only).
Produces: raincloud_laa_la_ratio.png
"""
...
# ── Plot ──────────────────────────────────────────────────────────────────────
def main():
    parser = argparse.ArgumentParser(description='LAA/LA median HU ratio raincloud')
